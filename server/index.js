...
app.use(bodyParser.json()); //body parsing middleware. Requests frequently contain a body - if you want to use it in req.body, then you'll need some middleware to parse the body.
